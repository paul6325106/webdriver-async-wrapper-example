...
public class WebDriverAsyncWrapperInjectExample implements WebDriverAsyncWrapper {

    private final static String RESOURCE = "js/async-wrapper-inject.js";
    ...
    public WebDriverAsyncWrapperInjectExample(final WebDriver webDriver, final long defaultTimeoutMs) {
